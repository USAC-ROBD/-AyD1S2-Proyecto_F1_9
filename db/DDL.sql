...
CREATE TABLE CARPETA_ETIQUETA (
    ID_CARPETA_ETIQUETA INT PRIMARY KEY AUTO_INCREMENT,
    ID_CARPETA INT NOT NULL,
    ID_ETIQUETA INT NOT NULL,
    CONSTRAINT CARPETA_ETIQUETA_FK_CARPETA FOREIGN KEY (ID_CARPETA) REFERENCES CARPETA(ID_CARPETA) ON DELETE CASCADE,
    CONSTRAINT CARPETA_ETIQUETA_FK_ETIQUETA FOREIGN KEY (ID_ETIQUETA) REFERENCES ETIQUETA(ID_ETIQUETA)
);
...
CREATE TABLE COMPARTIR (                           -- tabla para compartir archivos y carpetas
    ID_COMPARTIR INT PRIMARY KEY AUTO_INCREMENT,
    ID_USUARIO_PROPIETARIO INT NOT NULL,
    ID_USUARIO_DESTINO INT NOT NULL,
    TIPO_COMPARTIR INT NOT NULL, -- 1: archivo, 2: carpeta
    ID_CARPETA INT, -- si es archivo, se deja en null
    ID_ARCHIVO INT, -- si es carpeta, se deja en null
    FECHA_COMPARTIR TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

    CONSTRAINT USUARIO_PROPIETARIO_FK FOREIGN KEY (ID_USUARIO_PROPIETARIO) REFERENCES USUARIO(ID_USUARIO),
    CONSTRAINT USUARIO_DESTINO_FK FOREIGN KEY (ID_USUARIO_DESTINO) REFERENCES USUARIO(ID_USUARIO),
    CONSTRAINT CARPETA_FK FOREIGN KEY (ID_CARPETA) REFERENCES CARPETA(ID_CARPETA),
    CONSTRAINT ARCHIVO_FK FOREIGN KEY (ID_ARCHIVO) REFERENCES ARCHIVO(ID_ARCHIVO)
);